  ...
  return (
    <div className="flex flex-col w-full items-center">
      <div>
        ...
        <div className="mt-4 max-w-screen-xl flex justify-center items-center mx-auto">
          <div className="flex gap-4 ">
            <div className="w-1/3  p-3 pr-0 rounded-2xl">
              <img
                src={hero4}
                alt="hero_discount_2"
                className="h-40 md:h-52 lg:h-72 xl:h-96 w-full object-cover rounded-xl"
              />
            </div>
            <div className="p-3 w-2/3 pl-0 ">
              <img
                src={hero5}
                alt="hero_discount_2"
                className="h-40 md:h-52 lg:h-72 xl:h-96 w-full object-cover rounded-xl"
